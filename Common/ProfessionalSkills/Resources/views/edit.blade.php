                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control" name="type">
                                    ...
                                    <option value="0" {{ $professionalskills->type == 0 ? 'selected' : '' }}>Major</option>
                                    <option value="1" {{ $professionalskills->type == 1 ? 'selected' : '' }}>Other</option>
                                </select>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="">Title</label>
                                <input type="text" name="title" value="{{$professionalskills->title}}" class="form-control"  placeholder="Title">
                            </div>
