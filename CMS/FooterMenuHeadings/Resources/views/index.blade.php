            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Footer Menu Headings</li>
                    </ul>
                </div>
                <div class="col-auto">
                    <a href="{{url('footer-menu-headings/create')}}" class="btn btn-success btn-sm">
