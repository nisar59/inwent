...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form action="{{url('inwent-legal/store')}}" method="POST" class="card">
                    @csrf
                    <div class="card-header p-3">
                        <h5 class="card-title">Add Inwent Legal</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="date" name="effective_date" class="form-control" placeholder="Enter Effective Date">
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="">Summary Of Changes</label>
                                <input type="text" name="summary_of_changes" class="form-control" placeholder="Enter Summary Of Changes">
                            </div>
