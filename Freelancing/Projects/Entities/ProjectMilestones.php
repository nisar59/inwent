...
class ProjectMilestones extends Model
{
    ...
    protected $fillable = ['project_id', 'user_from', 'user_to','milstone_price','expected_closing_date','name','description','status','request_completion','work_files','explaination','request_status','paid','agree_to_terms'];
